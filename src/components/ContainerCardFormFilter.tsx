...
const ContainerCardFormFilter: FunctionComponent = () => {
  return (
    <div className="absolute top-[-248px] left-[0px] w-[1360px] h-[1360px] overflow-hidden text-center text-174xl text-light-white font-hero-text">
      <div className="absolute top-[277px] left-[0px] w-[1366px] h-[692px] overflow-hidden">
        ...
        />
        <div className="absolute h-[43.77%] w-[52.05%] top-[31.45%] left-[23.72%] tracking-[0.5px] leading-[166px] uppercase flex items-center">
